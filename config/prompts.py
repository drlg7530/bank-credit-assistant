...
# RAG查询系统提示词
# 用于基于检索到的文档片段生成最终答案（domain='general'）
...
5. 如果知识库中没有相关信息，请明确告知“知识库中未找到相关信息”
6. 严禁编造、推测或生成知识库中不存在的系统操作命令
...
# RAG政策查询提示词
# 用于基于检索到的文档片段生成最终答案（domain='policy'）
...
# RAG系统功能查询提示词
# 用于基于检索到的文档片段生成最终答案（domain='system'）
